...
$(function () {
    ...
    $(".pop_main").click(function () {
        $(".pop_main").hide();// 隐藏页面
        document.getElementById("add_newusersfrom").reset();
    })
    ...
    $(".pop_main1").click(function () {
        $(".pop_main1").hide();// 隐藏页面
        document.getElementById("edi_newusersfrom").reset();
    })
